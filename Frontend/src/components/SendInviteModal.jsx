...
import { sendInvite } from "../api/projectInviteApi";

const ROLES = ["ADMIN", "MEMBER", "VIEWER"];

export default function SendInviteModal({ isOpen, onClose, projectId, onSent }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await sendInvite(projectId, {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="mb-4 text-xl font-bold text-white">Invite User</h2>
